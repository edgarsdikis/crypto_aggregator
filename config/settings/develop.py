...
ALLOWED_HOSTS = ['develop-api.yourdomain.com']  # Update with your develop domain
...
CORS_ALLOWED_ORIGINS = [
    'https://develop.yourdomain.com',  # Update with your develop frontend
...
CSRF_TRUSTED_ORIGINS = [
    'https://develop-api.yourdomain.com',  # Backend
